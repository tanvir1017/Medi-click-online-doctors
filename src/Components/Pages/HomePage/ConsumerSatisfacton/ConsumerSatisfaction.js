      ...
      <div className="row">
        <div className="col-md-4 col-sm-12 col-lg-4">
          ...
          <p className="text-start mb-5" style={{ lineHeight: "30px" }}>
            Over the last 9 years, we have served more than 4 million customers
            in Bangladesh, providing access to primary healthcare and risk
            protection in their times of need.
          </p>
          ...
          <div className="row">
            <div>
              ...
              <p className="text-start mb-5" style={{ lineHeight: "30px" }}>
                ...
                ensure users have a positive experience with all of our service
                dimensions.
              </p>
            </div>
          </div>
            ...
            <div className="col-md-4 col-lg-4 col-sm-12 mb-2">
              <div className="card h-100 alert alert-success">
                <div className="card-body">
                  ...
                  <p className="mt-2">
                    Getting Milvik Health was one of the best decisions I took.
                    Milvik doctors helped me during a lot of emergency health
                    situations. I also got super fast claims money from Milvik
...
export default ConsumerSatisfaction;
